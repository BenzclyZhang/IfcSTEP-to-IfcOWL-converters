...
/**
 * @author Chi
 * The class to manage mappings between IFC verions and namespaces of ifcOWL.
 */
public class IfcVersion {
	 ...
	 * @param versionName Name of the IFC version. It can be (ignore case) "IFC2X3_TC1", "IFC2X3_Final", "IFC4", "IFC4x1_RC3", "IFC4_ADD1","IFC4_ADD2".
	 * @return 
	...
	/**
	 * Intialize mapping between IFC versions and namespaces defined in nl.tue.ddss.convert.Namespace class.
	 */
	...
	/**
	 * Intialize mapping between namespaces defined in nl.tue.ddss.convert.Namespace class and IFC versions.
	 * @throws IfcVersionException
	 */
	...
	/**
	 * Intialize mapping between IFC versions and namespaces defined in ifcOWL files (*.ttl) in the resources folder.
	 * @throws IfcVersionException
	 */
	...
	/**
	 * Intialize mapping betweennamespaces defined in ifcOWL files (*.ttl) in the resources folder and  IFC versions.
	 * @throws IfcVersionException
	 */
